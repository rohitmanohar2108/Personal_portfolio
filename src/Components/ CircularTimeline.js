...
const CircularTimeline = ({ percentage, title, description }) => {
  ...
  return (
    <div className="relative z-20 flex flex-col items-center cursor-pointer bg-zinc-900 bg-opacity-20 border border-zinc-800 hover:border-white p-7 rounded-xl shadow-lg transition-colors duration-300" ref={containerRef}>
      ...
      <h3
        className="text-rose-600 text-3xl mt-4 font-dm-sans font-bold"
        ref={titleRef}
      >
        {title}
      </h3>
      <p
        className="text-white text-sm font-dm-sans font-xl font-bold"
        ref={descriptionRef}
      >
        {description}
      </p>
