...
const CircularTimeline = ({ percentage, title, description }) => {
  ...
  return (
    <div className="relative z-20 flex flex-col items-center cursor-pointer bg-zinc-900 border border-zinc-800 hover:border-white p-7 rounded-xl shadow-lg transition-colors duration-300" ref={containerRef}>
