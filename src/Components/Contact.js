  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <hr className="w-32 border-2 border-green-500 mb-6 mt-3 rounded-full -mx-3" />
      </div>
          ...
          >
            <div>
              ...
              <input
                ...
                id="name"
                name="name"
                className="w-full p-2 rounded-lg bg-gray-700 text-gray-300 border border-gray-600"
            ...
            <div>
              ...
              <input
                ...
                name="email"
                className="w-full p-2 rounded-lg bg-gray-700 text-gray-300 border border-gray-600"
                placeholder="manoharrohit372@gmail.com"
                required
              />
            </div>
            <div>
      ...
      {/* Map Section (Optional) */}
       <div className="bg-teal-950 p-6 rounded-lg shadow-md mt-8">
