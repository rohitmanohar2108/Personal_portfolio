...
const Contact = () => {
  return (
    <div className="p-6">
      {/* Header Section */}
      <div className="mb-6">
        <h1 className="text-white text-3xl font-acme mb-4 -mt-6 -mx-3">Contact</h1>
        
        <hr className="w-32 border-2 border-amber-400 -my-3 rounded-full -mx-3" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-zinc-900  p-6 rounded-lg shadow-md">
          <h2 className="text-2xl text-white font-acme mb-4">Get in Touch</h2>
          <form
      ...
      {/* Map Section (Optional) */}
       <div className="bg-zinc-900 p-6 rounded-lg shadow-md mt-8">
        <h2 className="text-2xl text-white font-acme mb-4">Our Location</h2>
        <iframe
