  ...
  return (
    <div className="p-6 rounded-lg shadow-lg mt-14">
      ...
      <div className="mb-6 -mt-20 -mx-6 resume-header">
        ...
        <hr className="w-32 border-2 border-yellow-600 mb-6 mt-3 rounded-full" />
      </div>
      ...
      <div className="mb-8 resume-section">
        ...
        <div className="bg-black p-6 rounded-lg shadow-md font-courier-prime hover:bg-stone-800">
      ...
      <div className="resume-section">
        ...
        <div className="bg-black p-6 rounded-lg shadow-md mb-4 font-courier-prime hover:bg-stone-800">
