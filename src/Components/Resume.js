  ...
  return (
    <div className="p-6 rounded-lg shadow-lg mt-14">
      ...
      <div className="timeline">
        <div className="timeline-item timeline-box">
          <div className="timeline-icon"></div>
          <div className="timeline-content bg-purple-800/50 p-6 rounded-lg shadow-md">
            <h3 className="text-xl text-gray-100 mb-2">2022</h3>
            <p className="text-gray-300">Event or milestone description for 2022.</p>
          </div>
        </div>
        <div className="timeline-item timeline-box">
          <div className="timeline-icon"></div>
          <div className="timeline-content bg-purple-800/50 p-6 rounded-lg shadow-md">
            <h3 className="text-xl text-gray-100 mb-2">2023</h3>
            <p className="text-gray-300">Event or milestone description for 2023.</p>
          </div>
        </div>
